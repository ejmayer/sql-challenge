...
-- ********RESULTS = DEPARTMENTS THAT ALL EMPLOYEES WORK/WORKED
...
-- ********RESULTS = DEPARTMENTS THAT ALL EMPLOYEES CURRENTLY/LAST WORK(ED)
SELECT employees.emp_no, employees.last_name, employees.first_name, departments.dept_name
FROM employees
	INNER JOIN dept_emp 
	ON (employees.emp_no = dept_emp.emp_no)
...
SELECT last_name, (last_name).count AS "Total Occurrences of Last Name"
FROM employees
GROUP BY last_name
